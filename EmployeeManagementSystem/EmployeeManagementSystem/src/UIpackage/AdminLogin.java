...
public class AdminLogin extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtAdminId, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    private void LogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogActionPerformed
        if(txtAdminId.getText().isEmpty()||txtAdminPassword.getText().isEmpty())
      {
      ...
      else
      {
          ...
          if(AdminId.equals("Admin")&& apass.equals("abc"))
          {
          ...
          {
              JOptionPane.showMessageDialog(rootPane, "Login Failed", "Login Form", JOptionPane.ERROR_MESSAGE);
          }
      }
